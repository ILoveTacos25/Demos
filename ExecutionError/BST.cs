...
namespace HW1
{
    public class BST
    {
        ...
        {
            int count = 0;
            if (tree != null) { count = Math.Max(levelCountHelper(tree.leftPointer), levelCountHelper(tree.rightPointer)) + 1; }
            return count;
        }
        ...
        /// </summary>
        /// <returns></returns>
        public double levelCount() { return levelCountHelper(this.rootPtr); }
        ...
        public int minLevelCount()
        {
            ...
            else if (itemCount > 1 && itemCount < 4) { return 1; }
